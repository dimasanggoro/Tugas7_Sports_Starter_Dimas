    ...
    Scaffold(
        topBar = {
            SportsAppBar(
                ...
                //tambahan untuk sportappbar agar tombol kembali tidak muncul dan panel aplikasi menampilkan Sports saat layar diperluas
...
//menambahkan composable Sport list dan detail
@Composable
private fun SportListAndDetail(
    sports: List<Sport>,
    selectedSport: Sport,
    onClick: (Sport) -> Unit,
    onBackPressed: () -> Unit,
